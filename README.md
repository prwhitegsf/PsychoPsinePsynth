...
2. that frequency is sent to each oscillator's Freq Mod, Carrier and Ring Mod 
...
Additionally, each module has an index / amp / depth parameter (3) corresponding the amplitude of the signal provided by the module
